...
<div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-xl-2">
          ...
          <button type="button" id="btn-info" class="border-top border-bottom border-left border-right-0" style="background: transparent;margin-top: 5px">
            <a class="inf"><img src="img/materials.png"><span>Materials</span></a>
          </button>
     
    
          <button type="button" id="btn-faculty" class="border-top border-bottom border-left border-right-0" style="background: transparent;margin-top: 5px">
          <a class="inf"><img src="img/grades.png"><span>Grades</span></a>
          </button>
     
          <button type="button" id="btn-discussions" class="border-top border-bottom border-left border-right-0" style="background: transparent;margin-top: 5px">
...
<script src="js/school-controlador.js"></script>
</body>
</html>