...
<body style="background-colo:#F9F9F8">
    ...
    <div class="container" style="margin-left: 60px">
      <form id=form-login class="border" style="padding-top: 20px;padding-left:20px;background-color: rgb(255, 255, 255)">
        ...
        <input class="caja-texto" type="text" id="cod-curso" style="margin-top: 10px;width: 92%;margin-top: 10px" placeholder="Course Code"><br>
        <div class="row">
    ...
    <script src="js/signup-estudiante-controlador.js"></script>
</body>
</html>